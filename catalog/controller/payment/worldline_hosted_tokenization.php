...
class WorldlineHostedTokenization extends \Opencart\System\Engine\Controller {
	private $error = [];
	private $separator = '';
	...
	public function index(): string {			
		...
		if ($setting['account']['api_key'][$environment] && $setting['account']['api_secret'][$environment]) {
			...
			return $this->load->view('extension/worldline/payment/worldline_hosted_tokenization', $data);
		}
	...
	public function modal(): void {
		...
		$this->response->setOutput($this->load->view('extension/worldline/payment/worldline_hosted_tokenization_modal', $data));
	}
}