...
$_['text_tab_hosted_checkout']   				= 'Paramètres de paiement hébergé';
$_['text_tab_hosted_tokenization']   			= 'Paramètres de tokenisation hébergés';
$_['text_tab_order_status']						= 'Statut de la commande';
$_['text_tab_transaction']						= 'Transactions';
$_['text_tab_suggest']							= 'Proposer une nouvelle fonctionnalité';
$_['text_live']   								= 'Vivre';
$_['text_test']   								= 'Test';
$_['text_api_credential_alert']					= 'Pour récupérer la clé API et le secret API dans votre PSPID, procédez comme suit :<br />1) Connectez-vous au portail Merhcant<br />2) Accédez à Développeur > API de paiement > Afficher la clé API<br />3) Si vous n\'avez encore rien configuré, créez à la fois la clé API et le secret API, puis cliquez sur « Ajouter une clé API ». Veuillez noter le secret API car il ne sera pas visible après l\'enregistrement.';
$_['text_webhook_credential_alert']				= 'Pour récupérer les informations d\'identification des webhooks, procédez comme suit :<br />1) Connectez-vous au portail marchand<br />2) Accédez à Développeur > Webhooks > Afficher la clé des webhooks.<br />3) Cliquez sur « Générer les clés Webhook » si aucune clé n\'est présente.<br />4) Copiez et collez immédiatement le WebhooksKeySecret, car il ne sera plus visible après l\'enregistrement.<br />5) Dans « URL des points de terminaison », collez l\'URL du Webhook de votre boutique à l\'aide de « Ajouter un point de terminaison Webhook »<br />5) Cliquez sur « ENREGISTRER » pour confirmer vos paramètres';
$_['text_pre_authorization']   					= 'Pré Autorisation';
$_['text_final_authorization']   				= 'Finale Autorisation';
$_['text_sale']   								= 'Vente';
$_['text_manually']								= 'Manuellement';
$_['text_next_day']								= 'À la fin de la journée';
$_['text_after_one_day']						= 'Après 1 jour';
$_['text_after_two_days']						= 'Après 2 jours';
$_['text_after_three_days']						= 'Après 3 jours';
$_['text_after_four_days']						= 'Après 4 jours';
$_['text_after_five_days']						= 'Après 5 jours';
$_['text_after_six_days']						= 'Après 6 jours';
$_['text_after_seven_days']						= 'Après 7 jours';
...
$_['text_capture_trigger_shipping']				= 'Lors de l\'expédition de la commande';
$_['text_capture_trigger_delivery']				= 'Lors de la livraison de la commande';
$_['text_capture_trigger_availability']			= 'Dès que la commande est disponible';
$_['text_capture_trigger_service_fulfilment']	= 'Une fois le service accompli';
$_['text_capture_trigger_other']				= 'Pour tout autre cas d\'utilisation';
$_['text_hosted_checkout_title']				= 'Worldline';
$_['text_hosted_tokenization_title']			= 'Cartes de crédit et de débit (Worldline)';
...
$_['text_twint']								= 'Une seule capture est autorisée pour Twint.';
...
$_['entry_capture_installation']				= 'Installation de capture';
$_['entry_group_cards']							= 'Cartes de groupe';
$_['entry_forced_tokenization']					= 'Tokenisation forcée';
$_['entry_surcharging_status']					= 'État de la surcharge';
...
$_['entry_wero_capture_trigger']				= 'Déclencheur de capture Wero';
$_['entry_final_order_status']					= 'Statut de la commande finale';
...
$_['entry_date_from']							= 'Date de création de';
$_['entry_date_to']								= 'Date de création à';
...
$_['help_capture_installation']					= 'Si vous définissez le mode d\'autorisation (préliminaire ou final) et sélectionnez une option d\'installation autre que l\'autorisation manuelle, le plugin lancera automatiquement une demande de capture de paiement sur la plateforme Worldline pour capturer le montant total de la transaction.';
...
$_['help_final_order_status']					= 'Définissez le statut de la commande sur final et Worldline ne pourra pas le modifier.';
...
$_['button_hosted_checkout_title']				= 'Payer avec Worldline';
$_['button_hosted_tokenization_title']			= 'Payer par carte';
